...
extension UIResponder {
    ...
    // new apis from v3.3
    @discardableResult
    func noticeSuccess(_ text: String, autoClear: Bool = true, autoClearTime: Int = 3) -> UIWindow{
        return SwiftNotice.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeError(_ text: String, autoClear: Bool = true, autoClearTime: Int = 3) -> UIWindow{
        return SwiftNotice.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeInfo(_ text: String, autoClear: Bool = true, autoClearTime: Int = 3) -> UIWindow{
